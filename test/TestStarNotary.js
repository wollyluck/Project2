...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(tokenName, "Cup Star Token");
...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('awesome star 3', tokenId1, {from: accounts[0]});
    await instance.createStar('awesome star 4', tokenId2, {from: accounts[1]});
...
it('lets a user transfer a star', async() => {
    ...
    await instance.createStar('awesome star 5', tokenId, {from: accounts[0]});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(name, 'awesome star 6');
});